...
function Pricing() {
  ...
  const plans = [
    ...
    },
    {
      ...
      price: "₹500",
      credits: 1000,
      description: "Best value for serious job preaperation.",
      features: [
        "1000 AI Interview Credits",
        "Advanced AI feedback",
        "Skill trend Analysis",
        "Priority AI Procssing",
      ],
      badge: "Best Value",
    },
  ];
  ...
  const handlePayment = async (plan) => {
    try {
      ...
      const amount = plan.id === "basic" ? 200 : plan.id === "pro" ? 500 : 0;
        ...
        {plans.map((plan) => {
          ...
          return (
            ...
            >
              ...
              {/* Default tag */}
              {plan.default && (
                <div className="absolute top-6 right-6 bg-gray-200 text-gray-700 text">
                  Default
                </div>
              )}
              ...
              <div className="mt-6 space-y-3 text-left">
                {plan.features.map((feauture, i) => (
                  <div key={i} className="flex items-center gap-3">
                    ...
                    <span className="text-gray-700 text-sm">{feauture}</span>
                  </div>
                ))}
              </div>
              {!plan.default && (
